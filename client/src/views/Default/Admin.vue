<script setup>
   import { ref } from 'vue';
   import Summary from '@/components/Charts/Summary_Admin.vue'
   ...
   const fetchData = async () => {
      ...
      stats.value = data
      count.value = [data.customers, data.professionals, data.requests, (data.revenue/1000)]
      percentage.value = [data.customer_progress, data.professional_progress, data.request_progress, data.revenue_progress]
      ratio.value = [data.completed, data.pending, data.rejected]
   }
      ...
      <div class="dashboard-summary mb-4">
         ...
         <div class="summary-card">
            ...
            <div class="summary-details">
               <h5>Total Revenue</h5>
               <p class="summary-number">₹{{ stats.revenue }}</p>
               <p class="summary-change"
                  :class="{'text-success': stats.revenue_progress >= 0, 'text-danger': stats.revenue_progress < 0}">
                  {{ stats.revenue_progress }}% from last month
               </p>
            </div>
         </div>
         ...
         <div class="summary-card">
            ...
            <div class="summary-details">
               ...
               <p class="summary-number">{{ stats.customers }}</p>
               <p class="summary-change"
         ...
         <div class="summary-card">
            ...
            <div class="summary-details">
               ...
               <p class="summary-number">{{ stats.professionals }}</p>
               <p class="summary-change"
                  :class="{'text-success': stats.professional_progress >= 0, 'text-danger': stats.professional_progress < 0}">
                  {{ stats.professional_progress }}% from last month
               </p>
            </div>
         </div>
