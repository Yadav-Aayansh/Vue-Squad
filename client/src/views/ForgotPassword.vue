<script setup>
    ...
    const sendResetLink = async() => {
        const response = await fetch(`${apiUrl}/reset-password?email=${email.value}`, {
            method: 'GET'
        })
...
<template>
                    ...
                    <div class="custom-card">
                        <div class="card-body">
                            <div class="card-title mb-3 d-flex align-items-center gap-2">
                                ...
                                <h3 class="mt-1">Forgot Your Password?</h3>
                            </div>
                            <p class="mb-3 text-center">Please enter your email address. You will receive a link to create a new
                            ...
                            <form @submit.prevent="sendResetLink">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <input class="form-control custom_input ps-5" type="email" v-model="email"
                                            minlength="3" maxlength="255" placeholder="Enter your email" required>
                                    </div>
                                </div>
    ...
    <!-- Popup Message Modal -->
    <Popup :isOpen="isMessage" title="Reset Link Sent" @close="isMessage=false" >
        <p>{{message}}</p>     
    </Popup>
</template>
